...
LOGOUTREQUEST;
	    ...
	    //3rd and 4th params can specify rsasha1 or 256 (change the algorithm)
	    //EX  XMLSecurityKey::RSA_SHA1  -- see Utils.php for details
	    $logoutRequest = Utils::addSign($logoutRequest, $key_needed, $cert_needed);
        } else {
