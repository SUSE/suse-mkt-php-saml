...
class Auth
{
    ...
    public function processSLO($keepLocalSession = false, $requestId = null, $retrieveParametersFromServer = false, $cbDeleteSession = null, $stay = false)
    {
        $this->_errors = array();
        $this->_lastError = $this->_lastErrorException = null;
//nomrally just checking $_GET['SAMLResponse']  BUT Okta sends thru POST - JUST DOING $_REQUEST FOR NOW
        if (isset($_REQUEST['SAMLResponse'])) {
            //CHANGED $_GET in next line to $_POST
            ...
            if (!$logoutRequest->isValid($retrieveParametersFromServer)) {
                ...
                if (isset($_REQUEST['RelayState'])) {
                    $parameters['RelayState'] = $_REQUST['RelayState'];
                }
